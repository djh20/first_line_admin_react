...
const headCells = [
  { id: '알림번호', numeric: true, disablePadding: true, label: '알림번호' },
  { id: '수신ID', numeric: false, disablePadding: false, label: '수신ID' },
  { id: '발신ID', numeric: false, disablePadding: false, label: '발신ID' },
  { id: '내용', numeric: false, disablePadding: false, label: '내용' },
  { id: '발신 시각', numeric: false, disablePadding: false, label: '발신 시각' },
  { id: '읽음', numeric: false, disablePadding: false, label: '읽음' },
];
...
export default function EnhancedTable() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = noticeStore.notices.map((notice) => notice.notice_id);
